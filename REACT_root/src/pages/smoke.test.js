...
async function smokeTest() {
    ...
    await driver.findElement(By.id(NEW_DOCUMENT_NAMEFIELD_ID)).sendKeys(DOCUMENT_NAME);
    ...
    await driver.findElement(By.id(SPLITPANE_NEW_NODE_NAMEFIELD_ID)).sendKeys(NODE_NAME);
    await driver.findElement(By.id(SPLITPANE_NEW_NODE_DESCFIELD_ID)).sendKeys(NODE_DESCRIPTION);
    }
