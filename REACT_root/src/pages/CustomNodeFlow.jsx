...
const CustomNodeFlow = () => {
    ...
    useEffect(() => {
        ...
        setElements([
            ...
            { id: '3', type: 'output', data: { label: 'Output A' }, position: { x: 726, y: 9 }, targetPosition: 'left' },
            { id: '4', type: 'output', data: { label: 'Output B' }, position: { x: 726, y: 84 }, targetPosition: 'left' },
    ...
    const graphStyles = { width: "100%", height: "500px", background: bgColor };


    return (
        <div>
            Advance graph with minimap and controls
            <ReactFlow
                elements={elements}
